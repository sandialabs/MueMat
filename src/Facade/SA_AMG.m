classdef SA_AMG < CopiableHandle
% This class provides a small facade class for a smoothed aggregation multigrid algorithm
% with identity matrix as default nullspace
    ...
    methods (Static = true)
        function [MgHierarchy] = Setup(Amat,Sm,maxlevels)
            ...
            MgHierarchy.FillHierarchy(SaPFactory(), TransPFactory(), RAPFactory(), 1, maxlevels);
